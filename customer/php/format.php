...
<div class="form">
  ...
  <div class="form-panel one">
    ...
    echo $path;
    if($_POST['submit1']){
        $sql="INSERT INTO `problem` (`ProblemId`, `ProblemDesc`, `TechnicianId`, `CustomerId`, `Status`) VALUES (NULL, '$pd', NULL, '$id', NULL);";
...
<div class="form-group">
          <input style="background:#353DB5;"type="submit" id="submit1" name="submit1" value="submit">
        </div>
...
<p>
  ...
  </p><audio id=recordedAudio></audio></div>
  </center>
        <div class="form-group">
          <input style="background:#353DB5;"type="submit" id="submit2" name="submit2" value="submit">
        </div>
      </form>
    </div>
  </div>
