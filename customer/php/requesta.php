...
<div class="form">
  ...
  <div class="form-panel one">
    ...
    if($_POST['submit']){
      ...
      $sql="INSERT INTO `problem` (`ProblemId`, `ProblemDesc`,`Audio`, `TechnicianId`, `CustomerId`, `Status`) VALUES (NULL, NULL,'$path', NULL, '$id', NULL);";
...
<br><br><br>
<p class="button2">
    <button class="btn btn-primary profile-button"type="button" id="record">Record</button>
